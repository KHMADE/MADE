...
/* 부품 판매 게시글 */
INSERT INTO PART VALUES('PA'||TO_CHAR('1707101335','RRMMDDHH24MI')||LPAD(1,2,'0'),'목재 80X50cm','WOOD',TO_DATE('1707101335','RRMMDDHH24MI'),1500,10,'기본 목재 샘플1','default_wood1.jpg');
INSERT INTO PART VALUES('PA'||TO_CHAR('1707121425','RRMMDDHH24MI')||LPAD(1,2,'0'),'목재 120X80cm','WOOD',TO_DATE('1707121425','RRMMDDHH24MI'),1800,15,'기본 목재 샘플2','default_wood2.jpg');
INSERT INTO PART VALUES('PA'||TO_CHAR('1707121435','RRMMDDHH24MI')||LPAD(1,2,'0'),'철채 150X80cm','STEEL',TO_DATE('1707121435','RRMMDDHH24MI'),2000,20,'기본 철재 샘플1','default_steel1.jpg');
INSERT INTO PART VALUES('PA'||TO_CHAR('1707131444','RRMMDDHH24MI')||LPAD(1,2,'0'),'철재 180X100cm','STEEL',TO_DATE('1707131444','RRMMDDHH24MI'),2300,5,'기본 철재 샘플2','default_steel2.jpg');
INSERT INTO PART VALUES('PA'||TO_CHAR('1707151015','RRMMDDHH24MI')||LPAD(1,2,'0'),'목재 150X80cm','WOOD',TO_DATE('1707151015','RRMMDDHH24MI'),2000,20,'기본 목재 샘플3','default_wood3.jpg');
INSERT INTO PART VALUES('PA'||TO_CHAR('1707151020','RRMMDDHH24MI')||LPAD(1,2,'0'),'목재 180X100cm','WOOD',TO_DATE('1707151020','RRMMDDHH24MI'),2300,5,'기본 목재 샘플4','default_wood4.jpg');
INSERT INTO PART VALUES('PA'||TO_CHAR('1707151115','RRMMDDHH24MI')||LPAD(1,2,'0'),'철재 150X80cm','STEEL',TO_DATE('1707151115','RRMMDDHH24MI'),2000,20,'기본 철재 샘플3','default_steel3.jpg');
INSERT INTO PART VALUES('PA'||TO_CHAR('1707151320','RRMMDDHH24MI')||LPAD(1,2,'0'),'철재 180X100cm','STEEL',TO_DATE('1707151320','RRMMDDHH24MI'),2300,5,'기본 철재 샘플4','default_steel4.jpg');


/* 디자인 판매 게시글 */
INSERT INTO DESIGN VALUES('DE'||TO_CHAR('1707101335','RRMMDDHH24MI')||LPAD(0,2,'0'),'목재서랍장1','WOOD',TO_DATE('1707101335','RRMMDDHH24MI'),'목재 서랍장1입니다.',15000,'default_design1.jpg','design11');
INSERT INTO DESIGN VALUES('DE'||TO_CHAR('1707121425','RRMMDDHH24MI')||LPAD(1,2,'0'),'목재서랍장2','WOOD',TO_DATE('1707121425','RRMMDDHH24MI'),'목재 서랍장2입니다.',10000,'default_design2.jpg','design11');
INSERT INTO DESIGN VALUES('DE'||TO_CHAR('1707121435','RRMMDDHH24MI')||LPAD(1,2,'0'),'철재서랍장1','STEEL',TO_DATE('1707121435','RRMMDDHH24MI'),'철재 서랍장1입니다.',20000,'default_design3.jpg','design22');
INSERT INTO DESIGN VALUES('DE'||TO_CHAR('1707131444','RRMMDDHH24MI')||LPAD(1,2,'0'),'철재서랍장2','STEEL',TO_DATE('1707131444','RRMMDDHH24MI'),'철재 서랍장2입니다.',35000,'default_design4.jpg','design22');
--
