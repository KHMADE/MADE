...
SELECT MEMBER_ID,MEMBER_PROFILE_IMG,PART_CODE,DESIGN_CODE,REVIEW_CONTENT,REVIEW_DATE  FROM MEMBER
...
TO_DATE('1999-01-01','RRRR-MM-DD'),'010-5688-2293','10332,서울,강남구 역삼동', SYSDATE, 'default_image.jpg',
99999,'관리자');
INSERT INTO MEMBER VALUES('design11','D','pass11','유정훈','aaaa@iei.or.kr','남',
TO_DATE('1999-02-10','RRRR-MM-DD'),'010-5688-2293','30221,서울시,강남구 역삼동', SYSDATE, 'default_image.jpg',
90000,'유사장');
INSERT INTO MEMBER VALUES('design22','D','pass22','김성권','ksk8948@iei.or.kr','남',
TO_DATE('1999-02-10','RRRR-MM-DD'),'010-3908-1072','30221,서울시,강남구 역삼동', SYSDATE, 'default_image.jpg',
90000,'김대리');
INSERT INTO MEMBER VALUES('user11','C','pass11','나상민','sm9171@iei.or.kr','남',
TO_DATE('1999-02-10','RRRR-MM-DD'),'010-6263-1960','30221,서울시,강남구 역삼동', SYSDATE, 'default_image.jpg',
90000,'나과장');
...
TO_DATE('1999-02-10','RRRR-MM-DD'),'010-9504-9598','30221,서울시,강남구 역삼동', SYSDATE, 'default_image.jpg',
90000,'정대리');
...
/* 상품 리뷰 데이터 작성 */
INSERT INTO ITEM_REVIEW VALUES(null,'DE170710133500','user11','잘 쓰고 있습니다. 짱 좋아여 헤헷',TO_DATE('1707121425','RRMMDDHH24MI'));
INSERT INTO ITEM_REVIEW VALUES(null,'DE170710133500','user22','이 제품 좋네요 감사히 쓰겠습니다.',TO_DATE('1707191505','RRMMDDHH24MI'));
INSERT INTO ITEM_REVIEW VALUES('PA170710133501',null,'user11','배송도 빠르고 좋네요 ^^',TO_DATE('1707121520','RRMMDDHH24MI'));
INSERT INTO ITEM_REVIEW VALUES('PA170710133501',null,'user22','아이템 후기 테스트',TO_DATE('1707121425','RRMMDDHH24MI'));
