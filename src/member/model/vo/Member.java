...
public class Member implements java.io.Serializable {
	...
	// UPDATE 용 생성자
	public Member(String id, String pwd, String email, String phone, String address, String profileImg) {
		super();
		this.id = id;
		this.pwd = pwd;
		this.email = email;
	...
	public String toString() {
		return "Member [id=" + id + ", classCode=" + classCode + ", pwd=" + pwd + ", name=" + name + ", birthday=" + birthday + ", email=" + email + ", phone=" + phone + ", address=" + address + ", signDate=" + signDate + ", profileImg="
				+ profileImg + ", point=" + point + ", nickName=" + nickName + "]";
	}
	public String getId() {
		return id;
	}
