...
public class PartListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Part> list = pservice.selectList(currentPage, limit);
		//ArrayList<Part> list = pservice.selectList();
		//System.out.println(list);
		
		RequestDispatcher view = null;
		if (list != null && list.size() > 0) {
			view = request.getRequestDispatcher("views/item/item_parts.jsp");
