...
public class QaDao {
	...
	public int insertQa(Connection con, Qa qa) {
		...
		String sql = "INSERT INTO QA VALUES('QA'||TO_CHAR(SYSDATE,'RRMMDDHH24MI')||LPAD(SEQ_DE.NEXTVAL,2,'0'),?,?,?,SYSDATE,null,null)";
	...
	public ArrayList<Qa> selectMemberQaList(Connection con,String member, int currentPage, int limit) {
		ArrayList<Qa> list = null;
		PreparedStatement pstmt = null;
		ResultSet rset = null;
	...
	public int getMemberListCount(Connection con,String member) {
		int listCount = 0;
		PreparedStatement pstmt = null;
		ResultSet rset = null;

		String query = "select count(*) from QA where MEMBER_ID=?";
