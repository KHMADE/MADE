...
/**
 * Servlet implementation class DesignUploadServlet
 */
@WebServlet("/designUploadImg")
public class DesignUploadServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DesignUploadServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String savePath = root + "images\\items\\designed\\desc";
		...
		out.print("http://localhost:3080/made/images/items/designed/desc/" + renameFileName);
		out.flush();
		out.close();
	}
