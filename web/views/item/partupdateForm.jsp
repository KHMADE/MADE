...
<body>
	...
	<section class="wrapper">
       <section class="page_head">
        ...
        <div class="container">
        <form id="update" method="post" action="/made/pupdate" enctype="multipart/form-data">
        <input type="hidden" id="code" name="code" value="<%=p.getPartId()%>">
        <table class="table table-bordered table-striped table-hover">
        <tr><td><b>상품명 : </b></td><td><input type="text" name="title" id="title" value="<%=p.getPartName()%>"></td></tr>
        <tr><td><b>가격 : </b></td><td><input type="number" name="price" id="price" min="0" value="<%=p.getPrice()%>"> 원</td></tr>
        <tr><td><b>매입재고 : </b></td><td><input type="number" name="quan" id="quan" min="1" value="<%=p.getQuantity()%>"> 개</td></tr>
        ...
        <textarea id="content" name="content" class="summernote"><%=p.getPartDesc()%></textarea></td></tr>
...
<!-- summernote apply -->
	...
	$("#update").submit(function( event ) {
		if($("#title").val() == ""){
            ...
            alert($("#title").val()+" 상품, "+$("#quan").val()+"개로 수정되었습니다!!!");
            return;
        }
});
  $(function() {
	var category = "<%=p.getPartCategory()%>";
