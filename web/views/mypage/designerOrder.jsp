<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="designer.model.vo.*, java.sql.Date, java.util.ArrayList" %>    

<%
	ArrayList<DesignerOrder> list = (ArrayList<DesignerOrder>) request.getAttribute("list");
...
<head>
	...
	<title>Designer Order - MAːDÆ</title>
