 ...
 * Generated at: 2017-08-11 11:22:20 UTC
...
public final class noticeDetail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/notice/../../header.jsp", Long.valueOf(1502449876165L));
    _jspx_dependants.put("/views/notice/../../footer.jsp", Long.valueOf(1502450508520L));
  }
  ...
  static {
    ...
    _jspx_imports_classes.add("noticereply.model.vo.NoticeReply");
...
return;
	...
	int currentPage = ((Integer)request.getAttribute("currentPage")).intValue();
      ...
      out.write("\t<title> QA - MAːDÆ</title>\r\n");
      ...
      out.write("  <!--  <script>\r\n");
      out.write("\t\t$(function(){\r\n");
      out.write("\t\t\t$(\"#replywrite\").click(function(){\r\n");
      out.write("\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\turl : \"/made/nrinsert\",\r\n");
      out.write("\t\t\t\t\tdata : 'member',member,\r\n");
      out.write("\t\t\t\t\tdataType : \"text\",\r\n");
      out.write("\t\t\t\t\ttype : \"post\",\r\n");
      out.write("\t\t\t\t\tsuccess : function(value){\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t},\r\n");
      out.write("\t\t\t\t\terror : function(value){\r\n");
      out.write("\t\t\t\t\t\talert(\"답글을 입력해주세요.\");\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t});\r\n");
 ...
 if(m != null &&(m.getClassCode().equals("A") || m.getClassCode().equals("D"))) {
      ...
      out.write("\r\n");
      out.write("\t\t\t<form action=\"/made/qaupdate\" method=\"post\">\r\n");
      out.write("\t\t\t\t<div class=\"panel-body article\">\r\n");
      out.write("\t\t\t\t\t<h4>\r\n");
      out.write("\t\t\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"panel-body content\">\r\n");
      out.write("\t\t\t\t\t\t");
      out.print(n.getNoticeContents() );
      out.write("\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
...
if(m.getClassCode().charAt(0)=='A'){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-default\" onclick=\"top.location.href='/made/ndelete?nnum=");
      out.print( n.getNoticeCode() );
      out.write("'\">\r\n");
      out.write("\t\t\t\t\t\t\t\t삭제하기\r\n");
      out.write("\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-default\" onclick=\"top.location.href='/made/nupview?nnum=");
      out.print( n.getNoticeCode() );
      out.write("&page=");
      ...
      out.write("\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<form action=\"/made/nrinsert\" method=\"post\">\r\n");
      out.write("\t\t\t\t");
if(m!=null){ 
      out.write("\r\n");
      ...
      out.print(currentPage);
      out.write("\" name=\"page\">\r\n");
      out.write("\t\t\t\t<div class=\"news_comments\">\r\n");
      out.write("                            <div class=\"dividerHeading\">\r\n");
      out.write("                                <h4><span>댓글 (");
      out.print(list.size());
      out.write(")</span></h4>\r\n");
      out.write("                            </div>\r\n");
      out.write("                            ");
 for(NoticeReply r:list){ 
      ...
      out.write("                            <input type=\"hidden\" id=\"replyCode\" class=\"replyCode\" name=\"replyCode\" value=\"");
      out.print(r.getReplyCode());
      out.write("\">\r\n");
      out.write("                                <ul class=\"comment-list\">                              \r\n");
      out.write("                                    <li class=\"comment\">\r\n");
      out.write("                                        <div class=\"avatar\"><img alt=\"\" src=\"/made/images/userimage/");
      out.print(r.getMemberImg() );
      out.write("\" class=\"avatar\"></div>\r\n");
      out.write("                                        <div class=\"comment-container\">\r\n");
      out.write("                                            <h4 class=\"comment-author\" ><a href=\"#\">");
      out.print(r.getMemberId() );
      out.write("</a></span></h4>\r\n");
      out.write("                                            <div class=\"comment-meta\"><a href=\"#\" class=\"comment-date link-style1\">");
      out.print(r.getReplyDate() );
      out.write("</a></div>\r\n");
      out.write("                                            <div class=\"comment-body replyContents\">\r\n");
      out.write("                                                <p>");
...
if(m!=null){ 
 ...
 if( r.getMemberId().equals(m.getId())){ 
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-default btn-xs updateConfirm1\" name=\"updateConfirm1\" id=\"updateConfirm1\" style=\"display: none;\">수정완료</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t&nbsp;&nbsp;&nbsp;<button type=\"button\" class=\"btn btn-default btn-xs update1\" name=\"update1\" id=\"update1\">수정하기</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t&nbsp;&nbsp;&nbsp;<button type=\"button\" class=\"btn btn-default btn-xs delete1\" name=\"delete1\" id=\"delete1\">삭제하기</button></p>\r\n");
      out.write("                            ");
}} 
      out.write("\r\n");
      out.write("                            </div>\r\n");
...
if(m!=null){
      out.write("\r\n");
      out.write("                            <div class=\"comment-box row\">\r\n");
      out.write("                                <div class=\"col-sm-12\">\r\n");
      out.write("                                    <p>\r\n");
      out.write("                                        <textarea name=\"content\" class=\"form-control\" rows=\"6\" cols=\"40\" onfocus=\"if(this.value == 'Message') { this.value = ''; }\" onblur=\"if(this.value == '') { this.value = 'Message'; }\" placeholder=\"Message\"></textarea>\r\n");
      out.write("                                    </p>\r\n");
      out.write("                                </div>\r\n");
      out.write("                            </div>\r\n");
      out.write("                            <p align=\"center\"><input type=\"submit\" class=\"btn btn-default\" value=\"댓글쓰기\">\r\n");
      out.write("         \t\t\t\t\t&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("         \t\t\t\t\t<button type=\"button\" class=\"btn btn-default\" onclick=\"top.location.href='/made/nlist?page=1'\">\r\n");
      out.write("\t\t\t\t\t\t\t\t목록보기\r\n");
      out.write("\t\t\t\t\t\t\t</button></p>\r\n");
      out.write("         \t\t\t\t\t");
}else{ 
      ...
      out.write("\t\t\tdata : data,\r\n");
      out.write("\t\t\ttype : \"post\",\r\n");
      out.write("\t\t\turl : '/made/noticeUpload', // servlet url\r\n");
...
if (m!=null){
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t$(function(){\r\n");
      out.write("                                    $(\".updateConfirm1\").on('click',function(){\r\n");
      out.write("                                    \tvar parentP = $(this).parent();\r\n");
      out.write("                                        var parentDiv = parentP.parent();\r\n");
      out.write("                                        var siblingUl = parentDiv.children('ul.comment-list');\r\n");
      out.write("                                        var replyCode = parentDiv.children('input').val();\r\n");
      out.write("                                        var updtContent = parentP.children(\".updateContent\").val();\r\n");
      out.write("                                        console.log(updtContent);\r\n");
      out.write("                                        \r\n");
      out.write("                                        $.ajax({\r\n");
      out.write("                                            url : \"/made/nrupdate\",\r\n");
      out.write("                                            type : \"post\",\r\n");
      out.write("                                            data: {\r\n");
      out.write("                                            \tnnum : \"");
      out.print(n.getNoticeCode());
      ...
      out.print(m.getId());
      out.write("\",\r\n");
      out.write("                                                reviewCode : replyCode,\r\n");
      ...
      out.write("                                        });\r\n");
      out.write("                                        \r\n");
      out.write("                                        parentDiv.find(\".replyContents\").html(updtContent);\r\n");
      out.write("                                        parentP.children(\".updateContent\").remove();\r\n");
      out.write("                                        parentP.children(\".updateConfirm1\").toggle(\"fast\");\r\n");
      out.write("                                        parentP.children('.update1').text(\"수정하기\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\t});\r\n");
      out.write("                                    \r\n");
      out.write("\t\t\t\t\t\t\t\t\t$(\".update1\").on('click',function(){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvar parentP = $(this).parent();\r\n");
      out.write("                                        var parentDiv = parentP.parent();\r\n");
      out.write("                                        var siblingUl = parentDiv.children('ul.comment-list');\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvar content = siblingUl.find('div.replyContents p').text().trim();\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t$(\".delete1\").on('click',function(){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvar parentP = $(this).parent();\r\n");
      out.write("                                        var parentDiv = parentP.parent();\r\n");
      out.write("                                        var replyCode = parentDiv.children('input').val();\r\n");
      out.write("                                        \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t$.ajax({\r\n");
      out.write("                                            url : \"/made/nrdelete\",\r\n");
      out.write("                                            type : \"post\",\r\n");
      out.write("                                            data: {\r\n");
      out.write("                                            \treplyCode : parentDiv.children($(\"input[type=hidden]\")).val(),\r\n");
      out.write("                                            \tid : \"");
      out.print(m.getId());
      out.write("\",\r\n");
      out.write("                                            \treviewCode : replyCode\r\n");
