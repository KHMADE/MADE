 ...
 * Generated at: 2017-08-06 16:48:53 UTC
...
public final class designupdateForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/item/../../footer.jsp", Long.valueOf(1502038060988L));
  }
...
return;
	...
	int max = plist.size();
      ...
      out.write("\t<title>디자인 상품 게시글 수정 페이지 - MAːDÆ</title>\r\n");
 ...
 if(m != null && m.getClassCode().charAt(0) == 'A'){ 
      ...
      out.write("\t\t\t\t\t\t<h2>디자인 상품 게시글 수정</h2>\r\n");
      out.write("\t\t\t\t\t\t<nav id=\"breadcrumbs\">\r\n");
      out.write("\t\t\t\t\t\t\t<ul>\r\n");
      out.write("\t\t\t\t\t\t\t\t<li>You are here:</li>\r\n");
      out.write("\t\t\t\t\t\t\t\t<li><a href=\"/made/index.jsp\">Home</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t<li><a href=\"/made/designitemlist?page=1\">Design</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t<li>Design Item Update</li>\r\n");
      out.write("\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t</nav>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t</section>\r\n");
      out.write("        <div class=\"container\">\r\n");
      out.write("        <form id=\"update\" method=\"post\" action=\"/made/dupdate?id=");
      out.print(d.getDesignId() );
      out.write("\" enctype=\"multipart/form-data\">\r\n");
      out.write("        <input type=\"number\" name=\"partCnt\" id=\"partCnt\" style=\"display: none;\">\r\n");
      out.write("        <table class=\"table table-bordered table-striped table-hover\">\r\n");
      out.write("        <tr><td><b>상품명 : </b></td><td><input type=\"text\" name=\"title\" id=\"title\" value=\"");
      out.print(d.getDesignName());
      out.write("\"></td></tr>\r\n");
      out.write("        <tr><td><b>디자이너 명 : </b></td><td>");
      out.print( d.getDesignerId() );
      out.write("</td></tr>\r\n");
      out.write("        <tr><td><b>카테고리 : </b></td><td>\r\n");
      out.write("        <select name=\"category\" id=\"category\" style=\"text-ailgn:center;\">\r\n");
      out.write("        \t<option value=\"\">--- 선택 ---</option>\r\n");
      out.write("        \t<option value=\"WOOD\">목재</option>\r\n");
      out.write("        \t<option value=\"STEEL\">철재</option>\r\n");
      out.write("        \t<option value=\"PLASTIC\">플라스틱</option>\r\n");
      out.write("        \t<option value=\"ETC\">기타</option>\r\n");
      out.write("        </select></td></tr>\r\n");
      out.write("        <tr><td><b>완제품 가격 : </b></td><td><input type=\"number\" name=\"price\" id=\"price\" min=\"0\" value=\"");
      out.print(d.getDesignPrice());
      out.write("\"> 원</td></tr>\r\n");
      out.write("        <tr><td><b>부품 사용 유무 </b></td><td>\r\n");
      out.write("        ");
 if (plist.size() < 1) { 
      out.write("\r\n");
      out.write("        \t<input class=\"btn-primary\" type=\"checkbox\" id=\"partSelect\" name=\"partSelect\">사용\r\n");
      out.write("        \t&nbsp;&nbsp;&nbsp;<button type=\"button\" class=\"btn btn-default\" name=\"addPart\" id=\"addPart\" style=\"display: none;\"><i class=\"fa fa-plus\"></i></button>\r\n");
      out.write("        \t&nbsp;&nbsp;&nbsp;<button type=\"button\" class=\"btn btn-default\" name=\"delPart\" id=\"delPart\" style=\"display: none;\"><i class=\"fa fa-minus\"></i></button>\r\n");
      out.write("        \t<div id=\"partlist\" class=\"partlist\" style=\"margin-top:7px; display: none;\">\r\n");
      out.write("        \t<select name=\"part1\" id=\"part1\" style=\"text-ailgn:center;\">\r\n");
      out.write("        \t<option value=\"\">--- 선택 ---</option>\r\n");
      out.write("        \t");
 for(Part p : plist_all){ 
      ...
      out.write("\r\n");
      out.write("        \t</select>&nbsp;&nbsp;&nbsp;<input type=\"number\" id=\"partQuan1\" name=\"partQuan1\" min=\"1\" max=\"50\" size=\"3\">&nbsp;SET\r\n");
      out.write("        \t&nbsp;&nbsp;&nbsp;\r\n");
      out.write("        \t</div>\r\n");
      out.write(" \t\t");
 } else { 
      out.write("\r\n");
      out.write(" \t\t\t<input class=\"btn-primary\" type=\"checkbox\" id=\"partSelect\" name=\"partSelect\" checked>사용\r\n");
      out.write(" \t\t\t&nbsp;&nbsp;&nbsp;<button type=\"button\" class=\"btn btn-default\" name=\"addPart\" id=\"addPart\"><i class=\"fa fa-plus\"></i></button>\r\n");
      out.write("        \t&nbsp;&nbsp;&nbsp;<button type=\"button\" class=\"btn btn-default\" name=\"delPart\" id=\"delPart\"><i class=\"fa fa-minus\"></i></button>\r\n");
      out.write("        \t");
 for(int i = 0; i<plist.size(); i++){ 
      out.write("\r\n");
      out.write("        \t<div id=\"partlist\" class=\"partlist\" style=\"margin-top:7px;\">\r\n");
      out.write("        \t<select name=\"part");
      out.print( i+1 );
      out.write("\" id=\"part");
      out.print( i+1 );
      out.write("\" style=\"text-ailgn:center;\">\r\n");
      out.write("        \t<option value=\"\">--- 선택 ---</option>\r\n");
      out.write("        \t");
 for(Part p : plist_all){ 
      out.write("\r\n");
 ...
 if(p.getPartId().equals(plist.get(i).getPartId())) { 
      ...
      out.write("\r\n");
      out.write("        \t</select>&nbsp;&nbsp;&nbsp;<input type=\"number\" id=\"partQuan");
      out.print( i+1 );
      out.write("\" name=\"partQuan");
      out.print( i+1 );
      out.write("\" min=\"1\" max=\"50\" size=\"3\" value=\"");
      out.print(plist.get(i).getQuantity());
      out.write("\">&nbsp;SET\r\n");
      out.write("        \t&nbsp;&nbsp;&nbsp;\r\n");
      out.write("        \t</div>\r\n");
      out.write("        \t");
      ...
      out.write("\r\n");
      out.write("        \t</td></tr>\r\n");
      out.write("\t    <tr><td><p><b>첨부된 이미지 파일 : </b></p></td><td>\r\n");
      out.write("        <img id=\"img_preview\" style=\"width:100px; height:100px;\" class=\"img-circle\" src=\"/made/images/items/designed/");
      out.print(d.getDesignImg());
      out.write("\"><br>\r\n");
      out.write("        <tr><td><p><b>수정할 이미지 파일 : </b></p></td><td>\r\n");
      out.write("        <img id=\"img_preview\" class=\"img-circle\"><br>\r\n");
      out.write("        <input type=\"file\" id=\"input_file\"></td></tr>\r\n");
      out.write("        <tr><td colspan=\"2\"><p><b>상품 설명 :</b></p>\r\n");
      out.write("        <textarea id=\"content\" name=\"content\" class=\"summernote\">");
      ...
      out.write("        <button class=\"btn btn-default\" type=\"reset\">취소하기</button></td></tr>\r\n");
      out.write("        </table></form>\r\n");
      out.write("        <p align=\"center\"><button class=\"btn btn-default\" type=\"button\" onclick=\"javascript:history.go(-1);\">이전 페이지로</button></p>\r\n");
      out.write("        </div>\r\n");
      out.write("    </section>\r\n");
      out.write("    \r\n");
      ...
      out.write(";\r\n");
      out.write("\t\r\n");
      out.write("\t$(\"#update\").submit(function( event ) {\r\n");
      out.write("\t\tif($(\"#title\").val() == \"\"){\r\n");
      out.write("            alert(\"상품 명을 입력해주세요!\");\r\n");
      out.write("            $(\"#title\").focus();\r\n");
      out.write("            event.preventDefault();\r\n");
      out.write("        } else if($(\"#price\").val() == 0) {\r\n");
      out.write("            alert(\"상품 가격은 0원이 될 수 없습니다.\");\r\n");
      out.write("            $(\"#price\").focus();\r\n");
      out.write("            event.preventDefault();\r\n");
      out.write("        } else if($('#category option:selected').val() == \"\"){\r\n");
      out.write("            alert(\"카테고리를 선택해 주세요!!\");\r\n");
      out.write("            $(\"#category\").focus();\r\n");
      out.write("            event.preventDefault();\r\n");
      out.write("        } else if($('#quan').val() == \"\"){\r\n");
      out.write("            alert(\"재고 수량을 적어 주세요!!\");\r\n");
      out.write("            $(\"#quan\").focus();\r\n");
      out.write("            event.preventDefault();\r\n");
      out.write("        } else {\r\n");
      out.write("            $(\".partlist select\").each(function(){\r\n");
      out.write("                 if($(\"#partSelect\").is(\":checked\") && $(this).val() == \"\"){\r\n");
      out.write("                \talert(\"올바른 부품을 선택해주세요!\");\r\n");
      out.write("                  \t$(this).focus();\r\n");
      out.write("                   \tevent.preventDefault();\r\n");
      out.write("                 }\r\n");
      out.write("            });\r\n");
      out.write("    \t\t$(\".partlist input[type=number]\").each(function(){\r\n");
      out.write("    \t\t\tif($(\"#partSelect\").is(\":checked\") && $(this).val() == \"\"){\r\n");
      out.write("    \t\t\t\talert(\"필요한 부품 수량을 적어 주셔야 합니다.\");\r\n");
      out.write("    \t\t\t\t$(this).focus();\r\n");
      out.write("    \t\t\t\tevent.preventDefault();\r\n");
      out.write("    \t\t\t}\r\n");
      out.write("            });\r\n");
      out.write("    \t\t$(\"#partCnt\").val(cnt);\r\n");
      out.write("    \t\talert($(\"#title\").val()+\" 상품이 정상적으로 수정되었습니다!!!\");\r\n");
      out.write("        \treturn;\r\n");
      out.write("       \t}\r\n");
      out.write("\t});\r\n");
      out.write("  $(function() {\r\n");
      out.write("\t  //$(\"#partlist\").hide();\r\n");
      out.write("\t$(\"select option[value='");
      out.print( d.getDesignCategory());
      out.write("']\").attr(\"selected\", true);\r\n");
      out.write("\t$(\"#partSelect\").change(function(){\r\n");
      out.write("        if($(\"#partSelect\").is(\":checked\")){\r\n");
      out.write("            cnt = 1;\r\n");
      out.write("            $(\".partlist\").toggle(\"slow\");\r\n");
      out.write("            $(\"#addPart\").toggle(\"fast\");\r\n");
      out.write("            $(\"#delPart\").toggle(\"fast\");\r\n");
      out.write("        }else{\r\n");
      out.write("            cnt = 0;\r\n");
      out.write("        \t//$(\"#partlist\").hide(500);\r\n");
      out.write("            $(\".partlist\").not(\":first\").remove();\r\n");
      out.write("            $(\".partlist\").toggle(\"slow\");\r\n");
      out.write("            $(\"#addPart\").toggle(\"fast\");\r\n");
      out.write("            $(\"#delPart\").toggle(\"fast\");\r\n");
      out.write("        }\r\n");
      out.write("    });\r\n");
      out.write("     \r\n");
      out.write("    $(\"#addPart\").on(\"click\",function(){\r\n");
      out.write("    \tcnt++;\r\n");
      out.write("    \t$(\".partlist:first\").clone().insertAfter(\".partlist:last\");\r\n");
      out.write("        $(\".partlist:last select\").attr({\r\n");
      out.write("            name : 'part'+cnt,\r\n");
      out.write("            id : 'part'+cnt\r\n");
      out.write("        });\r\n");
      out.write("        $(\".partlist:last input[type=number]\").attr({\r\n");
      out.write("            name : 'partQuan'+cnt,\r\n");
      out.write("            id : 'partQuan'+cnt\r\n");
      out.write("        });\r\n");
      out.write("        //alert(cnt);\r\n");
      out.write("    });\r\n");
      out.write("    $(\"#delPart\").on(\"click\",function(){\r\n");
      out.write("    \tif(cnt <= 1){\r\n");
      out.write("            alert(\"더 이상 부품을 제거할 수 없습니다.\\n부품을 사용하지 않으신다면\\n사용 체크를 해제하세요!\");\r\n");
      out.write("        } else {\r\n");
      out.write("            $(\".partlist:last\").remove();\r\n");
      out.write("    \t\tcnt--;\r\n");
      out.write("        \t//alert(cnt);\r\n");
      out.write("    \t}\r\n");
      out.write("    });\r\n");
      ...
      out.write("\t<script type=\"text/javascript\" src=\"/made/views/user/project(sk).js\"></script>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
