 ...
 * Generated at: 2017-08-06 20:29:54 UTC
...
public final class designInsertForm_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
	...
	ArrayList<String> didlist = (ArrayList<String>)request.getAttribute("didlist");
      ...
      out.write("\t<title>디자인 상품 등록 페이지 - MAːDÆ</title>\r\n");
 ...
 if(m != null && m.getClassCode().charAt(0) == 'A'){ 
      ...
      out.write("\t\t</section>\r\n");
      out.write("        <div class=\"container\">\r\n");
      out.write("        <form id=\"insert\" method=\"post\" action=\"/made/dinsert\" enctype=\"multipart/form-data\">\r\n");
      ...
      out.write("        \t<select name=\"designer\" id=\"designer\" style=\"text-ailgn:center;\">\r\n");
      out.write("        \t<option value=\"\">--- 선택 ---</option>\r\n");
      out.write("        \t<option value=\"admin\">-- XXX --</option>\r\n");
      out.write("        \t");
 for(String d : didlist){ 
      ...
      out.write("        \t</select>\r\n");
      out.write("        \t</td></tr>\r\n");
      out.write("        <tr><td><b>완제품 가격 : </b></td><td><input type=\"number\" name=\"price\" id=\"price\" min=\"0\"> 원</td></tr>\r\n");
 ...
 for(Part p : plist){ 
      ...
      out.write("    \t\talert($(\"#title\").val()+\" 상품이 정상적으로 등록되었습니다!!!\");\r\n");
      out.write("        \treturn;\r\n");
      out.write("       \t}\r\n");
      out.write("\t});\r\n");
      out.write("  $(function() {\r\n");
