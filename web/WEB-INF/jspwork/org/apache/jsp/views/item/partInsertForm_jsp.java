 ...
 * Generated at: 2017-08-11 00:03:42 UTC
...
public final class partInsertForm_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t<title>부품 등록 페이지 - MAːDÆ</title>\r\n");
 ...
 if(m != null &&(m.getClassCode().equals("A") || m.getClassCode().equals("D"))) {
      ...
      out.write("\t\t\t\t\t\t<h2>부품 등록</h2>\r\n");
      out.write("\t\t\t\t\t\t<nav id=\"breadcrumbs\">\r\n");
      out.write("\t\t\t\t\t\t\t<ul>\r\n");
      out.write("\t\t\t\t\t\t\t\t<li>You are here:</li>\r\n");
      out.write("\t\t\t\t\t\t\t\t<li><a href=\"/made/index.jsp\">Home</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t<li><a href=\"/made/partitemlist?page=1\">Part</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t<li>Parts Item</li>\r\n");
      out.write("\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t</nav>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t</section>\r\n");
      out.write("        <div class=\"container\">\r\n");
      out.write("        <form id=\"insert\" method=\"post\" action=\"/made/pinsert\" enctype=\"multipart/form-data\">\r\n");
      out.write("        <table class=\"table table-bordered table-striped table-hover\">\r\n");
      out.write("        <tr><td><b>상품명 : </b></td><td><input type=\"text\" name=\"title\" id=\"title\"></td></tr>\r\n");
      out.write("        <tr><td><b>가격 : </b></td><td><input type=\"number\" name=\"price\" id=\"price\" min=\"0\"> 원</td></tr>\r\n");
      out.write("        <tr><td><b>매입재고 : </b></td><td><input type=\"number\" name=\"quan\" id=\"quan\" min=\"1\"> 개</td></tr>\r\n");
      ...
      out.write("        <tr><td><p><b>첨부 이미지 파일 : </b></p></td><td>\r\n");
      out.write("        <img id=\"img_preview\" style=\"width:100px; height:100px;\" class=\"img-circle\"><br>\r\n");
      out.write("        <input type=\"file\" id=\"input_file\" name=\"input_file\"></td></tr>\r\n");
      out.write("        <tr><td colspan=\"2\"><p><b>상품 설명 :</b></p>\r\n");
      out.write("        <textarea id=\"content\" name=\"content\" class=\"summernote\"></textarea></td></tr>\r\n");
      ...
      out.write("\t<script type=\"text/javascript\">\r\n");
      out.write("\t$(\"#insert\").submit(function( event ) {\r\n");
      ...
      out.write("            event.preventDefault();\r\n");
      out.write("        } else {\r\n");
      out.write("            alert($(\"#title\").val()+\" 상품, \"+$(\"#quan\").val()+\"개가 등록되었습니다!!!\");\r\n");
      out.write("            return;\r\n");
      out.write("        }\r\n");
      out.write("});\r\n");
      out.write("  $(function() {\r\n");
      ...
      out.write("\t<script type=\"text/javascript\" src=\"../user/project(sk).js\"></script>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
