 ...
 * Generated at: 2017-08-11 08:14:52 UTC
...
public final class likeList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("like.model.vo.Like");
...
return;
	...
	int listCount = ((Integer) request.getAttribute("listCount")).intValue();
      ...
      out.write("\t<title>찜 목록 리스트 - MAːDÆ</title>\r\n");
 ...
 if(list.size() != 0) { 
      ...
      out.write("\t\t\t\t  \t\t<thead>\r\n");
      out.write("\t\t\t\t  \t\t\t<tr><th>상품정보</th><th>금액/수량</th><th>취소</th></tr>\r\n");
      out.write("\t\t\t\t  \t\t</thead>\r\n");
      out.write("\t\t\t\t  \t\t<tbody>\r\n");
      out.write("\t\t\t\t  \t\t");
 for(Like e : list) { 
 ...
 if(e.getDesignCode() != null ) { 
      ...
      out.print( e.getDesignprice() );
      out.write("</td><td><button class=\"btn btn-default like_design\" id=\"like");
      out.print( e.getDesignCode() );
      out.write("\">♥ 찜 취소</button></tr>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t");
 } else { 
      out.write("\r\n");
 ...
 if(e.getPartCategory().equals("WOOD")){ 
      ...
      out.write("</a></div></div></td><td>");
      out.print( e.getPartPrice() );
      out.write("</td><td><button class=\"btn btn-default like_part\" id=\"like");
      out.print( e.getPartCode() );
      out.write("\">♥ 찜 취소</button></td></tr>\r\n");
      out.write("\t\t\t\t\t\t\t");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t");
 ...
 if(currentPage == maxPage) { 
      ...
      out.write("\t\t\t\t  \t</thead>\r\n");
      out.write("\t\t\t\t  \t<tbody>\r\n");
      out.write("\t\t\t\t  \t\t<tr><td colspan=\"3\" align=\"center\"><h3>현재 찜하신 아이템이 없습니다. ㅠㅜ</h3></td></tr>\r\n");
      out.write("\t\t\t\t  \t</tbody>\r\n");
      out.write("\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t");
 } 
      ...
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("$(\".like_design\").on('click',function(){\r\n");
      out.write("\tvar thisLike = $(this);\r\n");
      out.write("\tvar code = $(this).attr(\"id\").substring(4);\r\n");
      out.write("\t$.ajax({\r\n");
      out.write("\t\turl : \"/made/designLike\",\r\n");
      out.write("\t\ttype : \"post\",\r\n");
      out.write("\t\tdata : {\r\n");
      out.write("\t\t\tlike : 1,\r\n");
      out.write("\t\t\tmid : $(\"#m_id\").val(),\r\n");
      out.write("\t\t\tdid : code\r\n");
      out.write("\t\t},\r\n");
      out.write("\t\tsuccess : function(data) {\r\n");
      out.write("\t\t\tthisLike.parent().parent().remove();\r\n");
      ...
      out.write("\t});\r\n");
      out.write("});\r\n");
      out.write("$(\".like_part\").on('click',function(){\r\n");
      out.write("\tvar thisLike = $(this);\r\n");
      out.write("\tvar code = $(this).attr(\"id\").substring(4);\r\n");
      out.write("\t$.ajax({\r\n");
