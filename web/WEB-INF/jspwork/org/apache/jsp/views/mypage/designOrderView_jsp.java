 ...
 * Generated at: 2017-08-11 08:43:01 UTC
...
public final class designOrderView_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String dFull = (String)request.getAttribute("dFull");
      ...
      out.write("\t<title>Order Design View - MAːDÆ</title>\r\n");
 ...
 if(m != null &&(m.getClassCode().equals("A") || m.getClassCode().equals("D"))) {
      ...
      out.write("\t\t\t\t\t\t\t\t<img class=\"carousel-item img-rounded active\" style=\"width:'400px'; height: '300px';\" src=\"/made/images/items/designed/");
      ...
      out.write("\t\t\t\t\t\t\t<h4><span>상세 주문 내역</span></h4>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
 ...
 for(Part p : plist) {
      ...
      out.write("\t\t\t\t\t\t<div class=\"dividerHeading\">\r\n");
      out.write("\t\t\t\t\t\t\t<h4><span>주문 견적표</span></h4>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("                        <th>구매 갯수</th>\r\n");
      out.write("                        <th>계산 가격</th>\r\n");
      out.write("                    </tr>\r\n");
      out.write("                    </thead>\r\n");
      out.write("                    <tbody>\r\n");
      out.write("\t\t\t\t\t");
 ...
 for(Part p : plist) {
      out.write("\r\n");
      out.write("                    <tr>\r\n");
      out.write("                        <td><img style=\"width:70px; height:70px;\" class=\"img-circle img-responsive\" src=\"/made/images/items/parts/");
      out.print(p.getPartCategory().toLowerCase());
      out.write('/');
      out.print(p.getPartImg() );
      out.write("\" alt=\"\"/></td>\r\n");
      out.write("                        <td>");
      out.print(p.getPartName() );
      out.write("</td>\r\n");
      ...
      out.write("원</td>\r\n");
      out.write("                        <td>");
      out.print(p.getQuantity()*quan );
      out.write("개</td>\r\n");
      out.write("                        <td>");
      out.print(p.getPrice()*quan*p.getQuantity() );
      out.write("원</td>\r\n");
      out.write("                    </tr>\r\n");
      out.write("\t\t\t\t\t");
 } 
 ...
 if(dFull.equals("Y")){ 
      ...
      out.write("개</td>\r\n");
      out.write("                        <td>");
      out.print(d.getDesignPrice()*quan );
      out.write("원</td>\r\n");
      out.write("                    </tr>\r\n");
      out.write("\t\t\t\t\t");
 } 
      ...
      out.write("\t\t\t\t\t</tbody>\r\n");
      out.write("                </table>\r\n");
      out.write("\t\t\t\t\t<blockquote class=\"default\">\r\n");
      out.write("\t\t\t\t\t<p align=\"center\"><span class=\"dropcap default\">∴ </span><font id=\"totPrice\" style=\"font-size:17pt;\">총 구매 가격 : <i class=\"fa fa-won\"></i>&nbsp;&nbsp;</font></p>\r\n");
      out.write("\t\t\t\t\t<p align=\"center\">완제품 구매 시 부품 가격은 완제품 가격에 포함됩니다.</p>\r\n");
      out.write("\t\t\t\t\t\t<p align=\"center\">\r\n");
      out.write("\t\t\t\t\t\t<button class=\"btn btn-success btn-lg\" onclick=\"pay_test();\">결제하기</button>\r\n");
      out.write("\t\t\t\t\t\t&nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t<button class=\"btn btn-danger btn-lg\" onclick=\"javascript:history.back();\">취소하기</button>\r\n");
      out.write("\t\t\t\t\t\t&nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t</p>\r\n");
      ...
      out.write("\t\t$('#totPrice').append(x.toString().replace(/\\B(?=(\\d{3})+(?!\\d))/g, \",\"));\r\n");
      out.write("\t}\r\n");
      ...
      out.print(price);
      out.write(";\r\n");
      out.write("\t\t\tnumberWithCommas(price);\r\n");
      ...
      out.write("\t\t\t   // m_redirect_url : \"/made/orderconfirm\"\r\n");
      out.write("\t\t\t}, function(rsp) {\r\n");
      out.write("\t\t\t\tif (rsp.success) {\r\n");
      out.write("\t\t\t\t\t//[1] 서버단에서 결제정보 조회를 위해 jQuery ajax로 imp_uid 전달하기\r\n");
      out.write("\t\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\t\turl : \"/made/orderconfirm\", //cross-domain error가 발생하지 않도록 동일한 도메인으로 전송\r\n");
      out.write("\t\t\t\t\t\ttype : 'POST',\r\n");
      out.write("\t\t\t\t\t\tdataType : 'json',\r\n");
      out.write("\t\t\t\t\t\tdata : {\r\n");
      out.write("\t\t\t\t\t\t\titem : 'design',\r\n");
      out.write("\t\t\t\t\t\t\tcode : '");
      ...
      out.write("\t\t\t\t\t\t\tprice : rsp.paid_amount,\r\n");
      out.write("\t\t\t\t\t\t\tstatus : rsp.status,\r\n");
      out.write("\t\t\t\t\t\t\ttitle : rsp.name,\r\n");
      out.write("\t\t\t\t\t\t\tpg_tid : rsp.pg_tid,\r\n");
      out.write("\t\t\t\t\t\t\tbuyer_name : rsp.buyer_name,\r\n");
      out.write("\t\t\t\t\t\t\tpaid_at : rsp.paid_at,\r\n");
      out.write("\t\t\t\t\t\t\treceipt_url : rsp.receipt_url\r\n");
      ...
      out.write("\t\t\t\t\t\t\talert(msg);\r\n");
      out.write("\t\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t\talert(\"결제가 정상적으로 이루어지지 않았습니다.\\n결제 내역을 확인해 주세요.\");\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\tlocation.href=\"/made/views/mypage/orderConfirm.jsp?item=part&pay_method=\"+rsp.pay_method\r\n");
      out.write("\t\t\t\t\t\t+\"&quan=");
      out.print(quan);
      out.write("&nick=\"+rsp.buyer_name\r\n");
      out.write("\t\t\t\t\t\t+\"&date=\"+rsp.paid_at+\"&price=\"+rsp.paid_amount;\r\n");
      out.write("\t\t\t\t} else {\r\n");
