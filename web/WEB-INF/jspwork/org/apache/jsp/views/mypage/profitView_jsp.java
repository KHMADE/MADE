 ...
 * Generated at: 2017-08-08 23:42:41 UTC
...
public final class profitView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/mypage/../../header.jsp", Long.valueOf(1502234405783L));
    _jspx_dependants.put("/views/mypage/../../footer.jsp", Long.valueOf(1502234860914L));
  }
...
return;
 ...
 if(m != null &&(m.getClassCode().equals("A") || m.getClassCode().equals("D"))) {
      ...
      out.write("\t<h3>월 별 매출액 도표화</h3>\r\n");
      out.write("\t\t<div id=\"chart1\" style=\"width:700px; height:300px\"></div>\r\n");
      out.write("\t<h3>금년도 인기상품 판매 퍼센트</h3>\r\n");
      out.write("\t\t<div id=\"chart2\" style=\"width:700px; height:300px\"></div>\r\n");
      out.write("\t<h3>금년도 상위 5개 상품 판매 누계</h3>\r\n");
      out.write("\t\t<div id=\"chart3\" style=\"width:700px; height:300px\"></div>\r\n");
      out.write("\t\thttp://www.jqplot.com/examples/barLineAnimated.php\r\n");
      out.write("\t</section>\r\n");
      ...
      out.write("\t// 막대 그래프\r\n");
      out.write("    var s1 = [[2002, 112000], [2003, 122000], [2004, 104000], [2005, 99000], [2006, 121000], \r\n");
      out.write("    [2007, 148000], [2008, 114000], [2009, 133000], [2010, 161000], [2011, 173000]];\r\n");
      out.write("    var s2 = [[2002, 10200], [2003, 10800], [2004, 11200], [2005, 11800], [2006, 12400], \r\n");
      out.write("    [2007, 12800], [2008, 13200], [2009, 12600], [2010, 13100]];\r\n");
      out.write(" \r\n");
      out.write("    plot1 = $.jqplot(\"chart1\", [s2, s1], {\r\n");
      out.write("        // Turns on animatino for all series in this plot.\r\n");
      out.write("        animate: true,\r\n");
      out.write("        // Will animate plot on calls to plot1.replot({resetAxes:true})\r\n");
      out.write("        animateReplot: true,\r\n");
      out.write("        cursor: {\r\n");
      out.write("            show: true,\r\n");
      out.write("            zoom: true,\r\n");
      out.write("            looseZoom: true,\r\n");
      out.write("            showTooltip: false\r\n");
      out.write("        },\r\n");
      out.write("        series:[\r\n");
      out.write("            {\r\n");
      ...
      out.write("                showHighlight: false,\r\n");
      out.write("                yaxis: 'y2axis',\r\n");
      out.write("                rendererOptions: {\r\n");
      out.write("                    // Speed up the animation a little bit.\r\n");
      out.write("                    // This is a number of milliseconds.  \r\n");
      out.write("                    // Default for bar series is 3000.  \r\n");
      out.write("                    animation: {\r\n");
      out.write("                        speed: 2500\r\n");
      out.write("                    },\r\n");
      out.write("                    barWidth: 15,\r\n");
      out.write("                    barPadding: -15,\r\n");
      out.write("                    barMargin: 0,\r\n");
      out.write("                    highlightMouseOver: false\r\n");
      out.write("                }\r\n");
      out.write("            }, \r\n");
      out.write("            {\r\n");
      out.write("                rendererOptions: {\r\n");
      out.write("                    // speed up the animation a little bit.\r\n");
      out.write("                    // This is a number of milliseconds.\r\n");
      out.write("                    // Default for a line series is 2500.\r\n");
      out.write("                    animation: {\r\n");
      ...
      out.write("        },\r\n");
      out.write("        axes: {\r\n");
      out.write("            // These options will set up the x axis like a category axis.\r\n");
      out.write("            xaxis: {\r\n");
      out.write("                tickInterval: 1,\r\n");
      out.write("                drawMajorGridlines: false,\r\n");
      out.write("                drawMinorGridlines: true,\r\n");
      out.write("                drawMajorTickMarks: false,\r\n");
      out.write("                rendererOptions: {\r\n");
      out.write("                tickInset: 0.5,\r\n");
      ...
      out.write("                },\r\n");
      out.write("                rendererOptions: {\r\n");
      out.write("                    // align the ticks on the y2 axis with the y axis.\r\n");
      out.write("                    alignTicks: true,\r\n");
      out.write("                    forceTickAt0: true\r\n");
      out.write("                }\r\n");
      out.write("            }\r\n");
      out.write("        },\r\n");
      ...
      out.write("            show: true, \r\n");
      out.write("            showLabel: true, \r\n");
      out.write("            tooltipAxes: 'y',\r\n");
      out.write("            sizeAdjust: 7.5 , tooltipLocation : 'ne'\r\n");
      out.write("        }\r\n");
      out.write("    });\r\n");
      ...
      out.write("      ];\r\n");
      out.write("       \r\n");
      out.write("      var plot3 = $.jqplot('chart3', [data], {\r\n");
      out.write("        seriesDefaults: {\r\n");
      out.write("          // make this a donut chart.\r\n");
      out.write("          renderer:$.jqplot.DonutRenderer,\r\n");
      out.write("          rendererOptions:{\r\n");
      out.write("            // Donut's can be cut into slices like pies.\r\n");
      out.write("            sliceMargin: 3,\r\n");
      out.write("            // Pies and donuts can start at any arbitrary angle.\r\n");
      out.write("            startAngle: -90,\r\n");
      out.write("            showDataLabels: true,\r\n");
      out.write("            // By default, data labels show the percentage of the donut/pie.\r\n");
      out.write("            // You can show the data 'value' or data 'label' instead.\r\n");
      out.write("            dataLabels: 'value',\r\n");
      out.write("            // \"totalLabel=true\" uses the centre of the donut for the total amount\r\n");
      out.write("            totalLabel: true\r\n");
      out.write("          }\r\n");
      out.write("        }\r\n");
      out.write("      });\r\n");
      out.write("});\r\n");
